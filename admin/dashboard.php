...
<div class="card w-100 text-center shadowBlue">
  ...
  <?php
    $i = 0;
    $result = $conn->query("SELECT account.account_no, account.balance, user.name, user.email, user.phone_no 
    FROM account 
...
?>
                <tr>
                    ...
                    <td>
                        <a href="show.php?id=<?php echo $row['account_no'] ?>" class='btn btn-success btn-sm' data-toggle='tooltip' title="View More info">View</a>
                        <a href="dashboard.php?delete=<?php echo $row['account_no'] ?>" class='btn btn-danger btn-sm' data-toggle='tooltip' title="Delete this account">Delete</a>
                    </td>
                </tr>
<?php
            }
